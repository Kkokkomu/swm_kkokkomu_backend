...
public class Constant {
    ...
    public static final String VIDEO_SERVER_GENERATE_HOST = "http://10.0.4.47:8000/generate";
    public static final String VIDEO_SERVER_PROMPT_HOST = "http://10.0.4.47:8000/prompt";
